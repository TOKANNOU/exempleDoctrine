...
class Suppliers
{
    ...
    public function addSupplierProduct(Products $supplierProduct): self
    {
        if (!$this->supplierProducts->contains($supplierProduct)) {
            $this->supplierProducts[] = $supplierProduct;
            $supplierProduct->setSupplierID($this);
        }

        return $this;
    }

    public function removeSupplierProduct(Products $supplierProduct): self
    {
        if ($this->supplierProducts->removeElement($supplierProduct)) {
            // set the owning side to null (unless already changed)
            if ($supplierProduct->getSupplierID() === $this) {
                $supplierProduct->setSupplierID(null);
            }
        }
